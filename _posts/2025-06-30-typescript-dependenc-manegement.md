...
Node.js는 기본적으로 프로젝트 단위로 의존성을 관리합니다. 각 프로젝트 폴더에 package.json 파일이 있고, npm install을 실행하면 해당 프로젝트의 node_modules 폴더에만 패키지가 설치됩니다. 이는 Python의 가상환경과 비슷한 격리 효과를 제공합니다.
